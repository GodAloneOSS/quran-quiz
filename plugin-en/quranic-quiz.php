<?php
/**
 * Plugin Name: Quranic Quiz
 * Plugin URI: https://www.godalone.in/quran-qa/
 * Description: A beautiful, modern Quranic Quiz with Google sign-in, timed 10-question rounds (Easy/Medium/Hard/Mixed), live scoring, quiz history and a downloadable certificate. Place [quranic_quiz] on any page.
 * Version: 1.0.0
 * Author: godalone.in
 * Text Domain: quranic-quiz
